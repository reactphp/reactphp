...
interface LoopInterface
{
    ...
    /**
     * Enable read events for the given stream.
     *
     * @param stream $stream The PHP stream resource to check.
     */
    ...
    /**
     * Disable read events for the given stream.
     *
     * @param stream $stream The PHP stream resource to check.
     */
    ...
    /**
     * Enable write events for the given stream.
     *
     * @param stream $stream The PHP stream resource to check.
     */
    ...
    /**
     * Disable write events for the given stream.
     *
     * @param stream $stream The PHP stream resource to check.
     */

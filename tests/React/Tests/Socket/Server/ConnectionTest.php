...
namespace React\Tests\Socket\Server;

use React\Socket\Server\Connection;
use React\Socket\Server\Server;
use React\EventLoop\StreamSelectLoop;

class ConnectionTest extends TestCase
{
    /**
     * @covers React\Socket\Server\Connection::getRemoteAddress
     */
     ...
     * @covers React\Socket\Server\Connection::parseAddress
     */
